...
cd kernel
export TARGET_PRODUCT=jrdhz72_we_jb3 MTK_ROOT_CUSTOM=../mediatek/custom/ MTK_PATH_PLATFORM=../mediatek/platform/mt6572/kernel/ MTK_PATH_SOURCE=../mediatek/kernel/
make -j4
if ! [ -a $ZIMAGE ];
then
