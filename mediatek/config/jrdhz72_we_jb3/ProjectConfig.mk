...
CUSTOM_HAL_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv sp2519_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv sp2519_yuv
...
CUSTOM_KERNEL_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv sp2519_yuv
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = hi257_yuv hi351_yuv hi253_yuv gc0329_yuv sp2519_yuv
...
#Modified By Henry.Song 2013/08/14 for PR505270
...
# Begin modify for PR518262 by jizhi.xiao on 2013-09-03
# Stop PDP request after Clear Codes 33 & 29.
# MTK_SPECIFIC_SM_CAUSE=no
MTK_SPECIFIC_SM_CAUSE=yes
# End modify for PR518262 by jizhi.xiao on 2013-09-03
...
#modify by qixing.chen for PR500791 begin
MTK_VOICE_UNLOCK_SUPPORT=no
#modify by qixing.chen for PR500791 end
...
CUSTOM_MODEM=jrdhz72_we_jb3_hspa
...
#add JRD_EFUSE_SUPPORT to control efuse code for yarism panisonic
JRD_EFUSE_SUPPORT = no
#add JRD_PANASONIC_AUDIO_PARAM to use panasonic audio parameter
JRD_PANASONIC_AUDIO_PARAM=no
...
#add for Digicel audio parameter compile
JRD_DIGICEL_AUDIO_PARAM=no

#add for different charging current selecting
HZ_YARISM_SUPPORT = yes

#add for applying ShangHai temperature rising scheme
SH_TEMP_RISING_SUPPORT = no

#add for HD voice custom
JRD_HDVOICE_CUST=no
