...
static String8 keyDynamicVibspkStrong = String8("DynamicVibspkStrong");
#endif
...
status_t AudioMTKHardware::setCommonParameters(const String8 &keyValuePairs)
{
    ...
    do
    {
...
#if defined(MATV_AUDIO_SUPPORT)||defined(NMI_MATV_AUDIO_SUPPORT) //jiangjingjing add 20150129 for defect 127326
        ...
        #ifdef DYNAMIC_VIBSPK_STRONG
        if (param.getInt(keyDynamicVibspkStrong, value) == NO_ERROR)
        {
            ALOGD("keyDynamicVibspkStrong=%d", value);
            param.remove(keyDynamicVibspkStrong);
            AudioVIBSPKControl::getInstance()->setCurrentVibSpkGain(value);
            break;
        }
        #endif
...
String8 AudioMTKHardware::getCommonParameters(AudioParameter &param, AudioParameter &returnParam)
{
    ...
    do
    {
	    ...
	    //jiangjingjing-modify-for PR846708 -20141119-begin
           //if not support HiFi,don't add keyHiFiDACGet to returnParam
          #ifdef HIFIDAC_SWITCH
            returnParam.add(keyHiFiDACGet, value);
	  #endif
	  //jiangjingjing-modify-for PR846708 -20141119-end
            break;
        }
