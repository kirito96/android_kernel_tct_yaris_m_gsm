...
ifeq ($(TARGET_PRODUCT), soul4)
  LOCAL_CFLAGS += -DENHENCE_MIC_GAIN
endif
...
#jiangjingjing add 20150129 for defect 127326
ifeq ($(strip $(CUSTOM_KERNEL_MATV)),nmi5625)	
  LOCAL_CFLAGS += -DNMI_MATV_AUDIO_SUPPORT	
endif
#jiangjingjing add 20150129 for defect 127326

ifeq ($(strip $(TARGET_BUILD_MMITEST)),true)
  LOCAL_CFLAGS += -DJRD_MINI_TEST
endif

ifeq ($(MTK_VIBSPK_SUPPORT),yes)
  LOCAL_CFLAGS += -DMTK_VIBSPK_SUPPORT
endif
ifeq ($(MTK_ACF_AUTO_GEN_SUPPORT),yes)
  LOCAL_CFLAGS += -DMTK_VIBSPK_SUPPORT
  LOCAL_CFLAGS += -DMTK_ACF_AUTO_GEN_SUPPORT
endif
...
ifeq ($(MTK_DUAL_MIC_SUPPORT),yes)
  LOCAL_CFLAGS += -DMTK_DUAL_MIC_SUPPORT
  ifeq ($(MTK_DUAL_MIC_USER_CONTROL_SUPPORT),yes)
  LOCAL_CFLAGS += -DMTK_DUAL_MIC_USER_CONTROL_FEATURE
  endif
endif
