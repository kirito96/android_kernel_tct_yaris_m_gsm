...
void AudioMTKStreamOut::dokeyRouting(uint32_t new_device)
{
    ...
    #if defined(NMI_MATV_AUDIO_SUPPORT) 	//jiangjingjing add 20150129 for defect 127326
    else if ( AudioMATVController::GetInstance()->GetMatvEnable() )	
    {	
        //ALOGD("%s(), ChangeDevice33333!!!!!", __FUNCTION__); 	
        AudioMATVController::GetInstance()->ChangeDevice(new_device);	
        mDL1Attribute->mdevices = new_device;	
    }	
    #endif                      // jiangjingjing add 20150129 for defect 127326
...
{
	//return INVALID_OPERATION; //yang.sun delete 2015-08-26 for Defect539724
