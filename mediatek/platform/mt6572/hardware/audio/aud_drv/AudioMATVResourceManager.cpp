...
static const uint16_t kMatvChipSamplingRateHz = 44100;
...
static const AudioDigtalI2S::I2S_SRC kMatvChipClockSource = AudioDigtalI2S::SLAVE_MODE;
...
status_t AudioMATVResourceManager::SetMatvAFEConnection(const bool enable)
{
