...
HI257WriteCmosSensor(0x23, 0x04); //Col :384L
...
HI257WriteCmosSensor(0x19, 0x01); // pmos switch on HI257WriteCmosSensor(for cfpn)
...
HI257WriteCmosSensor(0x3d, 0x03);//:384
...
HI257WriteCmosSensor(0xd0, 0x10);//:384
...
HI257WriteCmosSensor(0x42, 0x04);//Cb Offset0x05
...
HI257WriteCmosSensor(0x82, 0x71); //Sharp2D Filter  //jacky 73
...
HI257WriteCmosSensor(0x22, 0x20); //LSC R 1b->15 20130125 1f
HI257WriteCmosSensor(0x23, 0x1a); //LSC G 1a     lb 
...
HI257WriteCmosSensor(0x14, 0x52);	//CMCOFSGH 
HI257WriteCmosSensor(0x15, 0x30);	//CMCOFSGM
HI257WriteCmosSensor(0x16, 0x20);	//CMCOFSGL
HI257WriteCmosSensor(0x17, 0x2f);	//CMC SIGN
//CMC
HI257WriteCmosSensor(0x30, 0x6e);
HI257WriteCmosSensor(0x31, 0x4c);
HI257WriteCmosSensor(0x32, 0x1e);
HI257WriteCmosSensor(0x33, 0x13);
HI257WriteCmosSensor(0x34, 0x58);
HI257WriteCmosSensor(0x35, 0x05);
HI257WriteCmosSensor(0x36, 0x03);
HI257WriteCmosSensor(0x37, 0x3a);
HI257WriteCmosSensor(0x38, 0x7d);
//CMC OFS
HI257WriteCmosSensor(0x40, 0x0b);
HI257WriteCmosSensor(0x41, 0x8a);
HI257WriteCmosSensor(0x42, 0x83);
HI257WriteCmosSensor(0x43, 0x88);
HI257WriteCmosSensor(0x44, 0x0c);
HI257WriteCmosSensor(0x45, 0x84);
HI257WriteCmosSensor(0x46, 0x8b);
HI257WriteCmosSensor(0x47, 0xa1);
HI257WriteCmosSensor(0x48, 0x2b);
//CMC POFS
HI257WriteCmosSensor(0x50, 0x90);
HI257WriteCmosSensor(0x51, 0x1e);
HI257WriteCmosSensor(0x52, 0x8e);
HI257WriteCmosSensor(0x53, 0x02);
HI257WriteCmosSensor(0x54, 0x09);
HI257WriteCmosSensor(0x55, 0x8b);
HI257WriteCmosSensor(0x56, 0x83);
HI257WriteCmosSensor(0x57, 0x02);
HI257WriteCmosSensor(0x58, 0x88);
///// PAGE 15 END /////

///// PAGE 16 START /////
HI257WriteCmosSensor(0x03, 0x16); //page 16
HI257WriteCmosSensor(0x10, 0x31);//GMA_CTL
HI257WriteCmosSensor(0x18, 0x5e);//AG_ON
HI257WriteCmosSensor(0x19, 0x5d);//AG_OFF
...
//GMA
HI257WriteCmosSensor(0x30, 0x00);
HI257WriteCmosSensor(0x31, 0x07);
HI257WriteCmosSensor(0x32, 0x10);
HI257WriteCmosSensor(0x33, 0x2d);
HI257WriteCmosSensor(0x34, 0x56);
HI257WriteCmosSensor(0x35, 0x76);
HI257WriteCmosSensor(0x36, 0x92);
HI257WriteCmosSensor(0x37, 0xa8);
HI257WriteCmosSensor(0x38, 0xbc);
HI257WriteCmosSensor(0x39, 0xca);
HI257WriteCmosSensor(0x3a, 0xd3);
HI257WriteCmosSensor(0x3b, 0xdc);
HI257WriteCmosSensor(0x3c, 0xe5);
HI257WriteCmosSensor(0x3d, 0xeb);
HI257WriteCmosSensor(0x3e, 0xf1);
HI257WriteCmosSensor(0x3f, 0xf4);
HI257WriteCmosSensor(0x40, 0xf8);
HI257WriteCmosSensor(0x41, 0xfb);
...
HI257WriteCmosSensor(0x54, 0x46);
HI257WriteCmosSensor(0x55, 0x6f);
HI257WriteCmosSensor(0x56, 0x91);
HI257WriteCmosSensor(0x57, 0xa9);
...
HI257WriteCmosSensor(0x20, 0x58); //mcmc_sat_gain3
...
HI257WriteCmosSensor(0x70, 0x42); //4d
HI257WriteCmosSensor(0x71, 0x89); //81(+4),89(-4) //80

HI257WriteCmosSensor(0x76, 0x32);
HI257WriteCmosSensor(0x77, 0xa1);
HI257WriteCmosSensor(0x78, 0x22);//24
HI257WriteCmosSensor(0x79, 0x35); // Y Target 70 => 25, 72 => 26 //30jacky
...
HI257WriteCmosSensor(0x84, 0xbf); 
HI257WriteCmosSensor(0x85, 0x20); 
HI257WriteCmosSensor(0x86, 0x01); //EXPMin 12000.00 fps
HI257WriteCmosSensor(0x87, 0xf4); 
HI257WriteCmosSensor(0x88, 0x0b); //EXP Max(120Hz) 8.00 fps 
HI257WriteCmosSensor(0x89, 0x71); 
HI257WriteCmosSensor(0x8a, 0xb0); 
HI257WriteCmosSensor(0xa5, 0x0a); //EXP Max(100Hz) 8.33 fps 
HI257WriteCmosSensor(0xa6, 0xfc); 
...
HI257WriteCmosSensor(0x9c, 0x1b); //EXP Limit 1500.00 fps 
...
HI257WriteCmosSensor(0xb3, 0x16);//15
...
HI257WriteCmosSensor(0xba, 0x3b); // 1c
HI257WriteCmosSensor(0xbb, 0x39);// 1b
HI257WriteCmosSensor(0xbc, 0x38);// 1b
HI257WriteCmosSensor(0xbd, 0x37);// 1a

HI257WriteCmosSensor(0xc0, 0x10);
HI257WriteCmosSensor(0xc1, 0x30);// 40
HI257WriteCmosSensor(0xc2, 0x30);//40
HI257WriteCmosSensor(0xc3, 0x30);//30
...
//Indoor Weight
HI257WriteCmosSensor(0x20, 0x66);
HI257WriteCmosSensor(0x21, 0x66);
HI257WriteCmosSensor(0x22, 0x66);
HI257WriteCmosSensor(0x23, 0x66);
HI257WriteCmosSensor(0x24, 0x64);
HI257WriteCmosSensor(0x25, 0x44);
HI257WriteCmosSensor(0x26, 0x44);
HI257WriteCmosSensor(0x27, 0x46);
HI257WriteCmosSensor(0x28, 0x64);
HI257WriteCmosSensor(0x29, 0x44);
HI257WriteCmosSensor(0x2a, 0x44);
HI257WriteCmosSensor(0x2b, 0x46);
HI257WriteCmosSensor(0x2c, 0x74);
HI257WriteCmosSensor(0x2d, 0x47);
HI257WriteCmosSensor(0x2e, 0x74);
HI257WriteCmosSensor(0x2f, 0x46);
HI257WriteCmosSensor(0x30, 0x64);
HI257WriteCmosSensor(0x31, 0x47);
HI257WriteCmosSensor(0x32, 0x74);
HI257WriteCmosSensor(0x33, 0x46);
HI257WriteCmosSensor(0x34, 0x64);
HI257WriteCmosSensor(0x35, 0x44);
HI257WriteCmosSensor(0x36, 0x44);
HI257WriteCmosSensor(0x37, 0x46);
HI257WriteCmosSensor(0x38, 0x64);
HI257WriteCmosSensor(0x39, 0x44);
HI257WriteCmosSensor(0x3a, 0x44);
HI257WriteCmosSensor(0x3b, 0x46);
HI257WriteCmosSensor(0x3c, 0x66);
HI257WriteCmosSensor(0x3d, 0x66);
HI257WriteCmosSensor(0x3e, 0x66);
HI257WriteCmosSensor(0x3f, 0x66);
//OUT
...
HI257WriteCmosSensor(0x20, 0x34); //For AWB Speed
...
HI257WriteCmosSensor(0x84, 0x16);//21
HI257WriteCmosSensor(0x85, 0x4f);
HI257WriteCmosSensor(0x86, 0x1a);

HI257WriteCmosSensor(0x87, 0x4d);
HI257WriteCmosSensor(0x88, 0x24);//34
HI257WriteCmosSensor(0x89, 0x30);//38
HI257WriteCmosSensor(0x8a, 0x20);

HI257WriteCmosSensor(0x8b, 0x3a);//42
HI257WriteCmosSensor(0x8c, 0x30);//3b
HI257WriteCmosSensor(0x8d, 0x20);//30
HI257WriteCmosSensor(0x8e, 0x24);

HI257WriteCmosSensor(0x8f, 0x50);
HI257WriteCmosSensor(0x90, 0x4A);
HI257WriteCmosSensor(0x91, 0x43);
HI257WriteCmosSensor(0x92, 0x3D);
HI257WriteCmosSensor(0x93, 0x34);
HI257WriteCmosSensor(0x94, 0x2C);
HI257WriteCmosSensor(0x95, 0x26);
HI257WriteCmosSensor(0x96, 0x23);
HI257WriteCmosSensor(0x97, 0x20);
HI257WriteCmosSensor(0x98, 0x1d);
HI257WriteCmosSensor(0x99, 0x1a);
HI257WriteCmosSensor(0x9a, 0x1a);

HI257WriteCmosSensor(0x9b, 0x66);//77
...
HI257WriteCmosSensor(0xb8, 0xd2); //HI257WriteCmosSensor(0+,1-)High Cb , HI257WriteCmosSensor(0+,1-)Low Cr
...
void HI257NightMode(kal_bool Enable)
 {
	...
	HI257WriteCmosSensor(0x84, 0x4f);
	...
	HI257WriteCmosSensor(0xa6, 0x4f);
	HI257WriteCmosSensor(0xa7, 0x80);
	...
	HI257WriteCmosSensor(0xa6, 0x27);
	HI257WriteCmosSensor(0xa7, 0xc0);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	HI257WriteCmosSensor(0x03,0x20);
	HI257WriteCmosSensor(0x70, 0x50); //42
	...
	HI257WriteCmosSensor(0xa5,0x09);//exp max10 fps
	HI257WriteCmosSensor(0xa6,0x27);
	HI257WriteCmosSensor(0xa7,0xc0);
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	HI257WriteCmosSensor(0x03,0x00);
	HI257WriteCmosSensor(0x10,0x11);//91
	...
	HI257WriteCmosSensor(0x03,0x18);
	HI257WriteCmosSensor(0x14,0x00);//0b
	
	HI257WriteCmosSensor(0x03,0x20);
	HI257WriteCmosSensor(0x70, 0x42);
	//HI257WriteCmosSensor(0x2b,0x04);//Adaptive Off,1/100 Flicker
	//HI257WriteCmosSensor(0x30,0x78);
	HI257WriteCmosSensor(0xa5, 0x09); //EXP Max(100Hz) 10.00 fps
	HI257WriteCmosSensor(0xa6, 0x27);
...
BOOL HI257SetEffect(UINT16 Para)
	{
		...
		//HI257WriteCmosSensor(0x42, 0x00);//05
		//HI257WriteCmosSensor(0x43, 0x00);//05
		HI257WriteCmosSensor(0x44, 0x80);
		HI257WriteCmosSensor(0x45, 0x80);
		break;
		case MEFFECT_SEPIA:
