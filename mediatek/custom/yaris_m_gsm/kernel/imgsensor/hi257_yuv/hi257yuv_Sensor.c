...
void HI257InitSetting(void)
{
	...
	HI257WriteCmosSensor(0x09, 0x44);	// pclk drive confrol 
	...
	HI257WriteCmosSensor(0x88, 0x09); //EXP Max 60hz 8.00 fps 
	HI257WriteCmosSensor(0x89, 0xe3); 
	HI257WriteCmosSensor(0x8a, 0x40); 
	HI257WriteCmosSensor(0xa5, 0x09); //EXP Max 50hz 8.33 fps 
	...
	HI257WriteCmosSensor(0x9c, 0x1d); //EXP Limit 800.00 fps 
	HI257WriteCmosSensor(0x9d, 0x4c); 
	HI257WriteCmosSensor(0x9e, 0x01); //EXP Unit 
	HI257WriteCmosSensor(0x9f, 0xf4); 
	HI257WriteCmosSensor(0xa3, 0x00); //Outdoor Int 
	HI257WriteCmosSensor(0xa4, 0xd3); 
...
void HI257NightMode(kal_bool Enable)
{
	...
	if (Enable)
	{
		...
		if(ISDarkMode())//dark condition
		{
			...
			HI257WriteCmosSensor(0x03, 0x20);
			HI257WriteCmosSensor(0x83, 0x13); //EXP Normal 5.00 fps
			HI257WriteCmosSensor(0x84, 0xd6);
	...
	else
	{
		...
		HI257WriteCmosSensor(0xa5, 0x09); //EXP Max(100Hz) 5.00 fps 
		HI257WriteCmosSensor(0xa6, 0xeb); 
		HI257WriteCmosSensor(0xa7, 0x10); 
				  ...
				  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	HI257WriteCmosSensor(0x83, 0x06); //EXP Normal 33.33 fps 
	HI257WriteCmosSensor(0x84, 0x97); 
	HI257WriteCmosSensor(0x85, 0x80);

	HI257WriteCmosSensor(0x86, 0x01); 
	HI257WriteCmosSensor(0x87, 0xf4);

	HI257WriteCmosSensor(0xa5, 0x05);//exp max15
...
BOOL HI257setiso(UINT16 para)
{
	...
	case AE_ISO_200:
		//ISO200
		HI257WriteCmosSensor(0x03, 0x20); 
		HI257WriteCmosSensor(0xb2, 0x30); 
		break;
	case AE_ISO_400:
		//ISO400
		HI257WriteCmosSensor(0x03, 0x20); 
	...
	case AE_ISO_800:
		//ISO800
		HI257WriteCmosSensor(0x03, 0x20); 
		HI257WriteCmosSensor(0xb2, 0x50); 
		break;
	case AE_ISO_1600:
		//ISO1600
		HI257WriteCmosSensor(0x03, 0x20); 
...
BOOL HI257SetBanding(UINT16 Para)
{
	...
	if (HI257Status.Banding == AE_FLICKER_MODE_60HZ) 
	{
		...
		HI257WriteCmosSensor(0x83, 0x09);  //EXP Normal 8.33 fps 
		HI257WriteCmosSensor(0x84, 0xe3); 
	...
	else
	{
		...
		HI257WriteCmosSensor(0x83, 0x09);  //EXP Normal 10.33 fps 
		HI257WriteCmosSensor(0x84, 0xeb); 
		HI257WriteCmosSensor(0x85, 0x10); 
...
UINT32 HI257YUVSetVideoMode(UINT16 FrameRate)	
{
	...
	if(FrameRate>=30)
	{
		...
		HI257WriteCmosSensor(0x83, 0x03); //EXP Normal 33.33 fps 
		HI257WriteCmosSensor(0x84, 0x4a); 
		HI257WriteCmosSensor(0x85, 0xc8);
		...
		HI257WriteCmosSensor(0xa7, 0x4c);  

		HI257WriteCmosSensor(0x91, 0x01); //EXP Fixed 30.00 fps   
		HI257WriteCmosSensor(0x92, 0xa7);
		HI257WriteCmosSensor(0x93, 0x23);
	...
	*/
		...
		HI257WriteCmosSensor(0x9c, 0x1d);
		HI257WriteCmosSensor(0x9d, 0x4c);
