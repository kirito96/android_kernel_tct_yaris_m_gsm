...
{  
	...
	//smooth
	SP0A19_write_cmos_sensor(0xfd,0x00);
	//\B5\A5ͨ\B5\C0\BC\E4ƽ\BB\AC\E3\D0ֵ	
	...
	//Gr\A1\A2Gb\B5\A5ͨ\B5\C0\C4\DAƽ\BB\ACǿ\B6\C8  
	...
	//CCM
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x66);//80(\BA\ECɫ\BDӽ\FC\A3\AC\B7\F4ɫ\B2\BB\C0\ED\CF\EB)
	...
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xc4,0x56);
	SP0A19_write_cmos_sensor(0xc5,0x80);
	SP0A19_write_cmos_sensor(0xca,0x30);
	SP0A19_write_cmos_sensor(0xcb,0x45);
	...
	SP0A19_write_cmos_sensor(0x82,0xb0);//0xd0 Kavie 20141130
	...
	SP0A19_write_cmos_sensor(0x86,0xb0);//0xc0 Kavie 20141130
	...
	SP0A19_write_cmos_sensor(0x5b,0xb0);//0xe0 Kavie 20141130
	...
	SP0A19_write_cmos_sensor(0xe5,0x05);
	SP0A19_write_cmos_sensor(0xd3,0x05);
	SP0A19_write_cmos_sensor(0xd7,0x05);

	SP0A19_write_cmos_sensor(0xe6,0x09);//0x07 Kavie 20141130
	SP0A19_write_cmos_sensor(0xd4,0x09);//0x07 Kavie 20141130
	SP0A19_write_cmos_sensor(0xd8,0x09);//0x07 Kavie 20141130
	...
	SP0A19_write_cmos_sensor(0xec,0x2c);//0x30 Kavie 20141130
	...
	SP0A19_write_cmos_sensor(0xc0,0xff);
	SP0A19_write_cmos_sensor(0xc1,0xd8);
	SP0A19_write_cmos_sensor(0xd3,0xa8);
	SP0A19_write_cmos_sensor(0xd4,0xa8);
	SP0A19_write_cmos_sensor(0xd6,0x9c);
	SP0A19_write_cmos_sensor(0xd7,0x80);
	//HEQ        
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7c);
	SP0A19_write_cmos_sensor(0xde,0xB0);
	SP0A19_write_cmos_sensor(0xdf,0x80);
	//func enable
	SP0A19_write_cmos_sensor(0xfd,0x00);
...
UINT32 SP0A19Open(void)
{
	...
	if(SP0A19_fromsd == 1)//\CAǷ\F1\B4\D3SD\B6\C1ȡ//gepeiwei   120903
	{
		printk("________________from t!\n");
		SP0A19_Initialize_from_T_Flash();//\B4\D3SD\BF\A8\B6\C1ȡ\B5\C4\D6\F7Ҫ\BA\AF\CA\FD
	}
	else
	{
		SP0A19_Sensor_Init();
