...
static void HI708_Set_VGA_mode(void)
{
    ...
    HI708_write_cmos_sensor(0x9c, 0x06);
...
void HI708_night_mode(kal_bool enable)
{
    ...
    if(enable)
    {
        ...
        if(HI708_sensor.banding == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI708_write_cmos_sensor(0x83, 0x04);
            HI708_write_cmos_sensor(0x84, 0xf5);
            HI708_write_cmos_sensor(0x85, 0x88);
            HI708_write_cmos_sensor(0x86, 0x00);
            HI708_write_cmos_sensor(0x87, 0xfa);

            HI708_write_cmos_sensor(0x88, 0x04);
            HI708_write_cmos_sensor(0x89, 0xf5);
            HI708_write_cmos_sensor(0x8a, 0x88);
       ...
       else 
       {
            ...
            HI708_write_cmos_sensor(0x83, 0x04);
            HI708_write_cmos_sensor(0x84, 0xf1);
            HI708_write_cmos_sensor(0x85, 0xa0);
            HI708_write_cmos_sensor(0x86, 0x00);
            HI708_write_cmos_sensor(0x87, 0xfa);

            HI708_write_cmos_sensor(0x88, 0x04);
            HI708_write_cmos_sensor(0x89, 0xf1);
            HI708_write_cmos_sensor(0x8a, 0xa0);
...
BOOL HI708_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
        ...
        HI708_write_cmos_sensor(0x83, 0x66);
