...
void SP2519_Sensor_Init(void)
{
	...
	SP2519_write_cmos_sensor(0xf5,0xa8);
	SP2519_write_cmos_sensor(0xf6,0x7c);
	SP2519_write_cmos_sensor(0xf7,0xb4);
	SP2519_write_cmos_sensor(0xf8,0x80);
	...
	SP2519_write_cmos_sensor(0xfd,0x02);
	SP2519_write_cmos_sensor(0xe8,0x58);// in outdoor        
	SP2519_write_cmos_sensor(0xec,0x68); //in outdoor        
	SP2519_write_cmos_sensor(0xe9,0x60); //in normal         
	SP2519_write_cmos_sensor(0xed,0x68); //in normal         
	SP2519_write_cmos_sensor(0xea,0x58);//in dummy           
	SP2519_write_cmos_sensor(0xee,0x60); //in dummy          
	SP2519_write_cmos_sensor(0xeb,0x48);//in lowlight        
	SP2519_write_cmos_sensor(0xef,0x40); //in low light      
	...
	SP2519_write_cmos_sensor(0x73,0x20);
	SP2519_write_cmos_sensor(0x74,0x20);
	SP2519_write_cmos_sensor(0x75,0x28);
	...
	SP2519_write_cmos_sensor(0xfd,0x02);
	SP2519_write_cmos_sensor(0x15,0x9f);
	SP2519_write_cmos_sensor(0x16,0x92);
  //!f  ccm
  ...
  //f  ccm
	...
	SP2519_write_cmos_sensor(0xd4,0x90);
	SP2519_write_cmos_sensor(0xd5,0x88);
	SP2519_write_cmos_sensor(0xd6,0x88);

	SP2519_write_cmos_sensor(0xd7,0x98);
	SP2519_write_cmos_sensor(0xd8,0x90);
	SP2519_write_cmos_sensor(0xd9,0x88);
	SP2519_write_cmos_sensor(0xda,0x88);
