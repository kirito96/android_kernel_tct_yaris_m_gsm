...
//V1.0.2 20140305 Kavie for AWB 偏蓝，偏红问题  ,(20140306修改饱和度+0x08) 此版本Yaris3.5项目暂未使用,仅做保留参考
//V2.0.0   20140415 liuxin for 录像帧率问题，连拍问题
//V2.0.1 beta1   20140509 Kavie for sharding debug   修正行噪，sharding，indoor&F- AWB for Soul3.5
 //V2.0.2test 20140516 Kavie for sharding and windows 1520*1140    "sp2519yuv_Sensor MTK6572 Soul3.5 V2.0.2test.c"
 //V2.0.3test 20140520 Kavie for windows 1520*1140  ,add 0x36=0x28   "sp2519yuv_Sensor MTK6572 Soul3.5 V2.0.3test.c"
 //V2.0.4test 20140522 Kavie for windows 1520*1140  ,del 0x36=0x28   "sp2519yuv_Sensor MTK6572 Soul3.5 V2.0.4test.c"
 //V2.0.5 20140522 Kavie for windows_1520_1140 and windows_1552_1164   , "sp2519yuv_Sensor MTK6572 Soul3.5 V2.0.5  windows 1552-1164.c" for  TCL Soul3.5
 //V2.06 20140607 Kavie for 上电闪绿问题,通过p1,0x32,p2,0x26,0x27的位置调整。for  TCL Soul3.5 SP2519
 //V2.06 20140617 Kavie for  TCL Soul3.5 SP2519     change AWB,shading  from wanggeyi 20140617
...
//20140522 kavie
#if 0  //for window  kavie 20140522  通过此控制是否做扣窗口处理
#define windows_1520_1140   0

#define windows_1552_1164   1
#else   //不扣窗口处理
#define windows_1520_1140   0

#define windows_1552_1164   0
#endif
//end
...
void SP2519_night_mode(kal_bool bEnable)
{
	...
	if (bEnable)/*night mode settings*/
	{
		...
		if(SP2519_MPEG4_encode_mode == KAL_TRUE) /*video night mode*/
		{
			...
			SP2519_write_cmos_sensor(0x0f,0x00);//no resize

			SP2519_write_cmos_sensor(0xfd,0x00);
			SP2519_write_cmos_sensor(0x19,0x03);
			SP2519_write_cmos_sensor(0x30,0x00);
			SP2519_write_cmos_sensor(0x31,0x04);//binning
			...
			{	
				...
				//24M fix 12fps 2.5pll 50hz binning
				SP2519_write_cmos_sensor(0xfd,0x00);
				...
				SP2519_write_cmos_sensor(0x0a,0xd8);
				SP2519_write_cmos_sensor(0xfd,0x01);
			...
			{ 
...
#endif
#ifdef SP2519_24M_60M
				//24M fix 12fps 2.5pll 60hz binning
				SP2519_write_cmos_sensor(0xfd,0x00);
				...
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x05);
				SP2519_write_cmos_sensor(0x0a,0xdb);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
		...
		{   
			SP2519_write_cmos_sensor(0xfd,0x02);
			SP2519_write_cmos_sensor(0x0f,0x01);//resize

			SP2519_write_cmos_sensor(0xfd,0x00);
			SP2519_write_cmos_sensor(0x19,0x00);
			SP2519_write_cmos_sensor(0x30,0x00);
			SP2519_write_cmos_sensor(0x31,0x00);//UXGA
...
#endif  
#ifdef SP2519_24M_60M
				//24M 6-11fps 50HZ 2.5pll
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0x30);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0x0a,0xb5);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x88);
				SP2519_write_cmos_sensor(0xf8,0x71);
				SP2519_write_cmos_sensor(0x02,0x10);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x88);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0x3d,0x14);
				SP2519_write_cmos_sensor(0x3e,0x71);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0xc3);
				SP2519_write_cmos_sensor(0x89,0x87);
				SP2519_write_cmos_sensor(0x8a,0x43);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x80);
				SP2519_write_cmos_sensor(0xbf,0x08);
				SP2519_write_cmos_sensor(0xd0,0x80);
				SP2519_write_cmos_sensor(0xd1,0x08);
				SP2519_write_cmos_sensor(0xc9,0x80);
...
#endif
#ifdef SP2519_24M_60M
				//24M 6-11fps 2.5pll 60hz
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x02);
				SP2519_write_cmos_sensor(0x04,0xac);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0x0a,0xae);
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x72);
				SP2519_write_cmos_sensor(0xf8,0x72);
				SP2519_write_cmos_sensor(0x02,0x14);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x72);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0x3d,0x14);
				SP2519_write_cmos_sensor(0x3e,0x72);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0x7d);
				SP2519_write_cmos_sensor(0x89,0x7d);
				SP2519_write_cmos_sensor(0x8a,0x44);
				SP2519_write_cmos_sensor(0xfd,0x02);
	...
	else /*normal mode settings*/
	{
		...
		{		
			...
			if(SP2519_CAM_BANDING_50HZ == KAL_TRUE)/*video normal mode 50hz*/
			{
...
#endif
#ifdef SP2519_24M_60M
				//24M 2.5pll 15fps 50HZ Maxgain=0xf8 binning
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x04);
				SP2519_write_cmos_sensor(0x04,0x5c);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				...
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0xba);
				SP2519_write_cmos_sensor(0xf8,0x9b);
				SP2519_write_cmos_sensor(0x02,0x06);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0xba);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0x3d,0x08);
				SP2519_write_cmos_sensor(0x3e,0x9b);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0xc0);
				SP2519_write_cmos_sensor(0x89,0x4d);
				SP2519_write_cmos_sensor(0x8a,0x32);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x5c);
				SP2519_write_cmos_sensor(0xbf,0x04);
				SP2519_write_cmos_sensor(0xd0,0x5c);
				SP2519_write_cmos_sensor(0xd1,0x04);
				SP2519_write_cmos_sensor(0xc9,0x5c);
				SP2519_write_cmos_sensor(0xca,0x04);
			...
			else/*video normal mode 60hz*/
			{
...
#endif
#ifdef SP2519_24M_60M
				//24M fix 15fps 2.5pll 60HZ binning
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0xa2);
				SP2519_write_cmos_sensor(0x05,0x00);
				SP2519_write_cmos_sensor(0x06,0x00);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x00);
				...
				SP2519_write_cmos_sensor(0xfd,0x01);
				SP2519_write_cmos_sensor(0xf0,0x00);
				SP2519_write_cmos_sensor(0xf7,0x9b);
				SP2519_write_cmos_sensor(0xf8,0x9b);
				SP2519_write_cmos_sensor(0x02,0x08);
				SP2519_write_cmos_sensor(0x03,0x01);
				SP2519_write_cmos_sensor(0x06,0x9b);
				SP2519_write_cmos_sensor(0x07,0x00);
				SP2519_write_cmos_sensor(0x08,0x01);
				SP2519_write_cmos_sensor(0x09,0x00);
				SP2519_write_cmos_sensor(0xfd,0x02);
				...
				SP2519_write_cmos_sensor(0x3e,0x9b);
				SP2519_write_cmos_sensor(0x3f,0x00);
				SP2519_write_cmos_sensor(0x88,0x4d);
				SP2519_write_cmos_sensor(0x89,0x4d);
		...
		else/*capture normal mode*/
		{
			...
			if(SP2519_CAM_BANDING_50HZ == KAL_TRUE)/*capture normal mode 50hz*/
			{
...
#endif
#ifdef SP2519_24M_60M
				//24M 2.5pll 11fps 50HZ Maxgain=0xf8
				SP2519_write_cmos_sensor(0xfd,0x00);
				SP2519_write_cmos_sensor(0x03,0x03);
				SP2519_write_cmos_sensor(0x04,0x30);
				SP2519_write_cmos_sensor(0x05,0x00);
				...
				SP2519_write_cmos_sensor(0x8a,0x43);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0xc8);
				SP2519_write_cmos_sensor(0xbf,0x04);
				SP2519_write_cmos_sensor(0xd0,0xc8);
				SP2519_write_cmos_sensor(0xd1,0x04);
				SP2519_write_cmos_sensor(0xc9,0xc8);
				SP2519_write_cmos_sensor(0xca,0x04);
#endif
			}
			else/*capture normal mode 60hz*/
			{
				...
				SP2519_write_cmos_sensor(0x8a,0x44);
				SP2519_write_cmos_sensor(0xfd,0x02);
				SP2519_write_cmos_sensor(0xbe,0x74);
				SP2519_write_cmos_sensor(0xbf,0x04);
				SP2519_write_cmos_sensor(0xd0,0x74);
				SP2519_write_cmos_sensor(0xd1,0x04);
				SP2519_write_cmos_sensor(0xc9,0x74);
				SP2519_write_cmos_sensor(0xca,0x04);
#endif
			}
		}
...
//#else//2pll
	...
	SP2519_write_cmos_sensor(0x25,0xad);//0x8f kavie 20140430
	SP2519_write_cmos_sensor(0x21,0x10);
	SP2519_write_cmos_sensor(0x28,0x08);//0x0b kavie 20140430
	SP2519_write_cmos_sensor(0x1d,0x00);
	SP2519_write_cmos_sensor(0x6c,0x00);//add kavie 20140430
	SP2519_write_cmos_sensor(0x7a,0x5d);//0x41 kavie 20140430
	...
	SP2519_write_cmos_sensor(0x1c,0x17);//0x1f 20140508
	SP2519_write_cmos_sensor(0x2e,0xcf);
	SP2519_write_cmos_sensor(0x1f,0xd0);//0xf0 20140508
	SP2519_write_cmos_sensor(0xfd,0x01);
	
	//SP2519_write_cmos_sensor(0x32,0x00);  //del 20140607
...
/*
//20140508 add sp shiwenwen set
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0xa1,0x22);
	SP2519_write_cmos_sensor(0xa2,0x22);
	SP2519_write_cmos_sensor(0xa3,0x2A);
	SP2519_write_cmos_sensor(0xa4,0x2A);
	SP2519_write_cmos_sensor(0xa5,0x18);
	SP2519_write_cmos_sensor(0xa6,0x18);
	SP2519_write_cmos_sensor(0xa7,0x1D);
	SP2519_write_cmos_sensor(0xa8,0x1D);
	SP2519_write_cmos_sensor(0xa9,0x16);
	SP2519_write_cmos_sensor(0xaa,0x16);
	SP2519_write_cmos_sensor(0xab,0x1b);
	SP2519_write_cmos_sensor(0xac,0x1b);
	SP2519_write_cmos_sensor(0xad,0x06);
	SP2519_write_cmos_sensor(0xae,0x08);
	SP2519_write_cmos_sensor(0xaf,0x02);
	SP2519_write_cmos_sensor(0xb0,0x05);
	SP2519_write_cmos_sensor(0xb1,0x08);
	SP2519_write_cmos_sensor(0xb2,0x07);
	SP2519_write_cmos_sensor(0xb3,0x05);
	SP2519_write_cmos_sensor(0xb4,0x04);
	SP2519_write_cmos_sensor(0xb5,0x08);
	...
	*/
		#elif 0
	//20140516 sharding Kavie
	SP2519_write_cmos_sensor(0xfd,0x01);                        
	SP2519_write_cmos_sensor(0xa1,0x23);                        
	SP2519_write_cmos_sensor(0xa2,0x23);                        
	SP2519_write_cmos_sensor(0xa3,0x26);                        
	SP2519_write_cmos_sensor(0xa4,0x26);                        
	SP2519_write_cmos_sensor(0xa5,0x1c);                        
	SP2519_write_cmos_sensor(0xa6,0x1d);                        
	SP2519_write_cmos_sensor(0xa7,0x1d);                        
	SP2519_write_cmos_sensor(0xa8,0x1e);                        
	SP2519_write_cmos_sensor(0xa9,0x1a);                        
	SP2519_write_cmos_sensor(0xaa,0x1b);                        
	SP2519_write_cmos_sensor(0xab,0x1b);                        
	SP2519_write_cmos_sensor(0xac,0x1b);                        
	SP2519_write_cmos_sensor(0xad,0x06);                        
	SP2519_write_cmos_sensor(0xae,0x0e);                        
	SP2519_write_cmos_sensor(0xaf,0x0b);                        
	SP2519_write_cmos_sensor(0xb0,0x0b);                        
	SP2519_write_cmos_sensor(0xb1,0x06);                        
	SP2519_write_cmos_sensor(0xb2,0x0c);                        
	SP2519_write_cmos_sensor(0xb3,0x0a);                        
	SP2519_write_cmos_sensor(0xb4,0x0b);                        
	SP2519_write_cmos_sensor(0xb5,0x08);                        
	SP2519_write_cmos_sensor(0xb6,0x0c);                        
	SP2519_write_cmos_sensor(0xb7,0x0c);                        
	SP2519_write_cmos_sensor(0xb8,0x0e); 
	#else
		//20140617 sharding from wanggeyi
	SP2519_write_cmos_sensor(0xfd,0x01);                        
	SP2519_write_cmos_sensor(0xa1,0x23);                        
	SP2519_write_cmos_sensor(0xa2,0x23);                        
	SP2519_write_cmos_sensor(0xa3,0x26);                        
	SP2519_write_cmos_sensor(0xa4,0x26);                        
	SP2519_write_cmos_sensor(0xa5,0x1c);                        
	SP2519_write_cmos_sensor(0xa6,0x1c);  //0x1d                      
	SP2519_write_cmos_sensor(0xa7,0x1d);                        
	SP2519_write_cmos_sensor(0xa8,0x1d); //0x1e                       
	SP2519_write_cmos_sensor(0xa9,0x1a);                        
	SP2519_write_cmos_sensor(0xaa,0x1a);//0x1b                        
	SP2519_write_cmos_sensor(0xab,0x1b);                        
	SP2519_write_cmos_sensor(0xac,0x1b);                        
	SP2519_write_cmos_sensor(0xad,0x00);//0x06                        
	SP2519_write_cmos_sensor(0xae,0x00);//0x0e                        
	SP2519_write_cmos_sensor(0xaf,0x00); //0x0b                       
	SP2519_write_cmos_sensor(0xb0,0x00); //0x0b                       
	SP2519_write_cmos_sensor(0xb1,0x00);//0x06                        
	SP2519_write_cmos_sensor(0xb2,0x00); //0x0c                       
	SP2519_write_cmos_sensor(0xb3,0x00); //0x0a                       
	SP2519_write_cmos_sensor(0xb4,0x00);  //0x0b                      
	SP2519_write_cmos_sensor(0xb5,0x00); //0x08                       
	SP2519_write_cmos_sensor(0xb6,0x00);//0x0c                        
	SP2519_write_cmos_sensor(0xb7,0x00); //0x0c                       
	SP2519_write_cmos_sensor(0xb8,0x00); //0x0e

#endif
	SP2519_write_cmos_sensor(0xfd,0x02);

	//SP2519_write_cmos_sensor(0x26,0xa0);  //20140607 del kavie
	//SP2519_write_cmos_sensor(0x27,0x96);  //20140607 del kavie
...
#elif 0//from shiwenwen 20140509 set
	SP2519_write_cmos_sensor(0x7c,0x13);
	SP2519_write_cmos_sensor(0x7d,0x3a);
	SP2519_write_cmos_sensor(0x7e,0xe6);
	SP2519_write_cmos_sensor(0x7f,0x0b);
	SP2519_write_cmos_sensor(0x80,0xa6);
	#else  //from wanggeyi 20140617
	SP2519_write_cmos_sensor(0x7c,0x09);//0x13
	SP2519_write_cmos_sensor(0x7d,0x2f);//0x3a
	SP2519_write_cmos_sensor(0x7e,0xf2);//0xe6
	SP2519_write_cmos_sensor(0x7f,0x15);//0x0b
	SP2519_write_cmos_sensor(0x80,0xa6);
#endif
	SP2519_write_cmos_sensor(0x70,0x0c);
	SP2519_write_cmos_sensor(0x71,0x28);
	SP2519_write_cmos_sensor(0x72,0x16);//0x0b //from wanggeyi 20140617
	SP2519_write_cmos_sensor(0x73,0x36);//0x28 //from wanggeyi 20140617
...
#else//from shiwenwen 20140509 set
	SP2519_write_cmos_sensor(0x61,0xce);
	SP2519_write_cmos_sensor(0x62,0xf2);
	SP2519_write_cmos_sensor(0x63,0x38);
	SP2519_write_cmos_sensor(0x64,0x5f);
	SP2519_write_cmos_sensor(0x65,0x5a);
#endif
...
*/	
	...
	SP2519_write_cmos_sensor(0xfd,0x02);
	//SP2519_write_cmos_sensor(0x36,0x20);//add GW offset max limit 20140520 kavie
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	SP2519_write_cmos_sensor(0xef,0x60);
		...
		#if windows_1520_1140 //kavie 20140516 windows
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0x4a,0x1e);//
	SP2519_write_cmos_sensor(0x4b,0x04);//1140
	SP2519_write_cmos_sensor(0x4c,0x74);//
	SP2519_write_cmos_sensor(0x4d,0x28);//
	SP2519_write_cmos_sensor(0x4e,0x05);//1520
	SP2519_write_cmos_sensor(0x4f,0xf0);//
	
	SP2519_write_cmos_sensor(0xfd,0x02);
	SP2519_write_cmos_sensor(0x0f,0x01);
	SP2519_write_cmos_sensor(0x40,0x00);
	SP2519_write_cmos_sensor(0x41,0x3c);//
	SP2519_write_cmos_sensor(0x42,0x00);
	SP2519_write_cmos_sensor(0x43,0x3c);//
	SP2519_write_cmos_sensor(0x44,0x02);
	SP2519_write_cmos_sensor(0x45,0x58);
	SP2519_write_cmos_sensor(0x46,0x03);
	SP2519_write_cmos_sensor(0x47,0x20);
	...
	SP2519_write_cmos_sensor(0x57,0x40);
	    #elif windows_1552_1164  //kavie 20140522 windows
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0x4a,0x12);//
	SP2519_write_cmos_sensor(0x4b,0x04);//
	SP2519_write_cmos_sensor(0x4c,0x8c);//1164
	SP2519_write_cmos_sensor(0x4d,0x18);//
	SP2519_write_cmos_sensor(0x4e,0x06);//1552
	SP2519_write_cmos_sensor(0x4f,0x10);//
	
	SP2519_write_cmos_sensor(0xfd,0x02);
	SP2519_write_cmos_sensor(0x0f,0x01);
	SP2519_write_cmos_sensor(0x40,0x00);
	SP2519_write_cmos_sensor(0x41,0x3e);//
	SP2519_write_cmos_sensor(0x42,0x00);
	SP2519_write_cmos_sensor(0x43,0x3e);//
	SP2519_write_cmos_sensor(0x44,0x02);
	SP2519_write_cmos_sensor(0x45,0x58);
	SP2519_write_cmos_sensor(0x46,0x03);
	SP2519_write_cmos_sensor(0x47,0x20);
...

{
	...
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0x4a,0x12);//
	SP2519_write_cmos_sensor(0x4b,0x04);//1164
	SP2519_write_cmos_sensor(0x4c,0x8c);//
	SP2519_write_cmos_sensor(0x4d,0x18);//
	SP2519_write_cmos_sensor(0x4e,0x06);//1552
	SP2519_write_cmos_sensor(0x4f,0x10);//
	     #else
...
UINT32 SP2519GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	#if windows_1520_1140
	pSensorResolution->SensorFullWidth=1520-8;//1524-4; for windows
	pSensorResolution->SensorFullHeight=1140-6;//1143-3; for windows
	#elif windows_1552_1164
	pSensorResolution->SensorFullWidth=1552-8;//1556-4; for windows
	pSensorResolution->SensorFullHeight=1164-6;//1167-3; for windows
	#else
		...
		MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	#if windows_1520_1140
	pSensorInfo->SensorFullResolutionX=1520-8;//1524-4; for windows
	pSensorInfo->SensorFullResolutionY=1140-6;//1143-3; for windows
	#elif windows_1552_1164
	pSensorInfo->SensorFullResolutionX=1552-8;//1556-4; for windows
	pSensorInfo->SensorFullResolutionY=1164-6;//1167-3; for windows
	#else
		...
		case SENSOR_FEATURE_SET_FLASHLIGHT:
			break;
                case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
                        SENSORDB("hujl@debug:sp2519 GET_TRIGGER_FLASHLIGHT_INFO\n");
