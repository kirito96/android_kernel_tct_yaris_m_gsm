...
static unsigned char CTPM_FW_CAMRY_MUTTO[]=
{
	...
	#include "YarisS_ID53_V12_20131018_app.i"
};
...
int fts_ctpm_auto_upg(unsigned char tp_vendor)
{
	...
	unsigned char version_list_camry_mutto[] = {0x0,0x10,0x11,0x12,0x13,0x14,0x15};  //Keep the Mutto tp firmware old version list that allows to be updated.
...
static int ft6306_pls_unlocked_ioctl(struct file *file, unsigned int cmd,unsigned long arg)   
 {
 ...
 static struct file_operations ft6306_pls_fops = {
	 ...
	 .unlocked_ioctl 	= ft6306_pls_unlocked_ioctl,
 };
