...
// battery capacity rectangle
	...
	#define CAPACITY_TOP                 (334)//(306)  //denggguangxi modify for defect 122634
	#define CAPACITY_RIGHT               (294)
	#define CAPACITY_BOTTOM              (538)//(510)  //denggguangxi modify for defect 122634
	#else
	...
	#define CAPACITY_BOTTOM              (573)
       #endif
	// first number rectangle
	#define NUMBER_LEFT                  (176) //(172) modify for defect 122634 
	#define NUMBER_TOP                   (213)
	#define NUMBER_RIGHT                 (214) //(210)modify for defect 122634 
	#define NUMBER_BOTTOM                (267)

	// %  rectangle
	#define PERCENT_LEFT                 (252) //(248) percent number_left + 2*number_width  modify for defect 122634 
	#define PERCENT_TOP                  (213)
	#define PERCENT_RIGHT                (300) //(296) modify for defect 122634 
